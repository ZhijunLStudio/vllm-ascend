...
| 配置 | Batch tok/s | Avg Latency | vs Baseline |
|------|------------|-------------|-------------|
| baseline | **541.0** | 0.772s | 1.00x |
| prefetch_g8n2s1 | 78.5 | 6.205s | 0.15x |
| prefetch_g8n2s2 | 81.3 | 6.024s | 0.15x |
| prefetch_g4n1s1 | 78.5 | 6.204s | 0.15x |
| prefetch_g4n1s2 | 81.3 | 6.024s | 0.15x |
...
| prefetch_g8n2s1 | 69.6 | 6.915s | 0.15x |
| prefetch_g8n2s2 | 69.8 | 6.883s | 0.15x |
| prefetch_g4n1s1 | 69.9 | 6.877s | 0.15x |
| prefetch_g4n1s2 | 69.7 | 6.880s | 0.15x |
